...
int main()
{
    ...
    for(char c = 'a'; c <= 'c'; c++) mp[c - 'a'] = 2;
    for(char c = 'd'; c <= 'f'; c++) mp[c - 'a'] = 3;
    for(char c = 'g'; c <= 'i'; c++) mp[c - 'a'] = 4;
    for(char c = 'j'; c <= 'l'; c++) mp[c - 'a'] = 5;
    for(char c = 'm'; c <= 'o'; c++) mp[c - 'a'] = 6;
    for(char c = 'p'; c <= 's'; c++) mp[c - 'a'] = 7;
    for(char c = 't'; c <= 'v'; c++) mp[c - 'a'] = 8;
    for(char c = 'w'; c <= 'z'; c++) mp[c - 'a'] = 9;

    for(ll i=0;i<n;i++){
        string str;
        cin>>str;
        ans=ans*10+mp[str[0]-'a'];
